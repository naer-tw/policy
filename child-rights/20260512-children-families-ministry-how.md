...
## 兒少預算追蹤怎麼做?(對標日本特別會計)
 ...
 單純升格並非萬能。本倡議主張「升格 + 預算追蹤 + 獨立監督」三軌並進。預算追蹤的設計分兩階段:
...
### Q4:英國 DCSF 只存在 3 年就被裁撤,升格能保證有效嗎?
...
依《中央行政機關組織基準法》第 32 條規定,行政院二級部會以 14 部、8 委員會、3 獨立機關為原則。目前實際運作部會數量,仍有政策調整空間;若有必要,亦可透過修正基準法上限因應重大政策需求,過去已有先例。
